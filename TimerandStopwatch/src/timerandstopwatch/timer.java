...
public class timer extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        panel1.setBackground(new java.awt.Color(60, 63, 65));

        timer.setBackground(new java.awt.Color(174, 176, 178));
        timer.setForeground(new java.awt.Color(174, 176, 178));
        ...
        stopwatch.setBackground(new java.awt.Color(174, 176, 178));
        ...
        jLabel4.setFont(new java.awt.Font("Arial Blue", 0, 25)); // NOI18N
        jLabel4.setForeground(Color.white);

        jLabel4.setText("STOPWATCH");

        jLabel5.setFont(new java.awt.Font("Arial Blue", 0, 25)); // NOI18N
        ...
        panel2.setBackground(new java.awt.Color(17, 255, 0));

        minutes.setFont(new java.awt.Font("Arial Blue", 1, 100));
        minutes.setText("00:");

        hours.setFont(new java.awt.Font("Arial Blue", 1, 100));
        hours.setText("00:");

        seconds.setFont(new java.awt.Font("Arial Blue", 1, 100));
        seconds.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        seconds.setText("00:");

        stop.setFont(new java.awt.Font("Tahoma", 1, 36));
        stop.setIcon(new javax.swing.ImageIcon(getClass().getResource("/timerandstopwatch/stop button.png")));
        ...
        reset.setFont(new java.awt.Font("Tahoma", 1, 196));
        reset.setIcon(new javax.swing.ImageIcon(getClass().getResource("/timerandstopwatch/reset button.png")));
        ...
        jPanel1.setBackground(new java.awt.Color(17, 255, 0));
        ...
        start1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/timerandstopwatch/button.png"))); // NOI18N
        ...
        reset1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/timerandstopwatch/stop button.png"))); // NOI18N
